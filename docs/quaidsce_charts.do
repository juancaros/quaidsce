...
gen elas_iu=elas_i+1.96*se_elas_i
gen elas_il=elas_i-1.96*se_elas_i
gen nelas_iu=nelas_i+1.96*se_nelas_i
gen nelas_il=nelas_i-1.96*se_nelas_i


tw (rcap elas_iu elas_il rw, horizontal) (scatter rw elas_i) (rcap nelas_iu nelas_il rw, horizontal) (scatter rw nelas_i), ylabel(1 "Starches" 2 "Bread" 3 "Breakfast cereal" 4 "Processed meats" 5 "Unprocessed meats" 6 "Milk and diary" 7 "Cheese" 8 "Fruits" 9 "Vegetables" 10 "Legumes and proccesed FV" 11 "Sweets" 12 "Snacks" 13 "Unsweetened drinks" 14 "Sweetened drinks" 15 "Fats & oils" 16 "Refined sugar" 17 "Nonsugar sweeteners") 

gen elas_uu=elas_u+1.96*se_elas_u
gen elas_ul=elas_u-1.96*se_elas_u
gen nelas_uu=nelas_u+1.96*se_nelas_u
gen nelas_ul=nelas_u-1.96*se_nelas_u
